  ...
  return (
    <div className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100">
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none z-0">
        <div
          className="absolute w-96 h-96 bg-blue-300 opacity-30 rounded-full filter blur-3xl animate-blob1"
          style={{ top: "-6rem", left: "-6rem" }}
        ></div>
        <div
          className="absolute w-96 h-96 bg-pink-300 opacity-30 rounded-full filter blur-2xl animate-blob2"
                ...
                {passwordVisible ? (
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a9.956 9.956 0 012.223-3.592m3.31-2.687A9.956 9.956 0 0112 5c4.478 0 8.268 2.943 9.542 7a9.973 9.973 0 01-4.043 5.306M15 12a3 3 0 11-6 0 3 3 0 016 0z"
                    />
                  </svg>
                )}
              </button>
