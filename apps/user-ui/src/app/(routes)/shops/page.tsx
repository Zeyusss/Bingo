...
const Page = () => {
  ...
  const activeFiltersCount = selectedCategories.length + selectedCountries.length + (minRating > 0 ? 1 : 0) + (shopSearch.trim() ? 1 : 0);
    ...
    <div className="w-full">
      ...
      <div className="relative w-full h-[300px] mb-0">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center px-4">
          ...
          <p className="text-lg mb-6">Discover talented artists and their unique creations</p>
              ...
              <div className="flex items-center gap-4 flex-wrap justify-end">
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <option value="followers_high">Sort by most followers</option>
                    <option value="followers_low">Sort by least followers</option>
                  </select>
            ...
            {/* Shop Grid */}
              {isShopLoading ? (
                <div className={`grid gap-4 ${
                  ...
                  {Array.from({ length: viewMode === "grid-3" ? 9 : 16 }).map((_, index) => (
                    <div
                      key={index}
