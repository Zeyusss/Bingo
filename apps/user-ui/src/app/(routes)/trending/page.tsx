...
const Page = () => {
  ...
  const fetchFilteredProducts = async () => {
    ...
    try {
      ...
      const apiUrl = `/product/api/get-trending-products?${query.toString()}`;
          ...
          <div className="text-center text-white px-4">
            <h1 className="text-5xl font-bold mb-4">
              {selectedCategories.length > 0
                ? `Trending ${selectedCategories[0]}`
                : "Trending This Week"}
            </h1>
            <p className="text-lg mb-6">Discover the most popular products this week</p>
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                ...
                <div className="flex items-center gap-4 flex-wrap justify-end">
                  ...
                  <div className="relative">
                    ...
                    >
                      <option value="trending">Sort by trending (most sold this week)</option>
