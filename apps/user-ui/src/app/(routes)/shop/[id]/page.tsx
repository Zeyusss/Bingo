...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: data?.shop?.avatar?.url || "https://ik.imagekit.io/w7lwh7wre/profile.webp?updatedAt=1754240423756",
          width: 800,
          height: 600,
    ...
    twitter: {
      ...
      description:
        data?.shop?.bio ||
        "Explore products and services from trusted sellers on Bingo.",
      images: [data?.shop?.avatar?.url || "https://ik.imagekit.io/w7lwh7wre/profile.webp?updatedAt=1754240423756"],
    },
  };
}
