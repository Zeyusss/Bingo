    ...
    const columns = useMemo(()=>[
        ...
        },
        {
            ...
            cell : ({row}: any) => (
                <span className={`px-2 py-1 rounded-full text-xs font-semibold 
                  ${row.original.deliveryStatus === "Delivered" ? "bg-green-600 text-white" :
                    row.original.deliveryStatus === "Out for Delivery" ? "bg-blue-500 text-white" :
                    row.original.deliveryStatus === "Shipped" ? "bg-purple-500 text-white" :
                    row.original.deliveryStatus === "Packed" ? "bg-yellow-500 text-white" :
        ...
        },
        {
            ...
            cell : ({row}:any) => (
                ...
                className='inline-block px-3 py-1 bg-blue-600 text-white rounded-md font-semibold hover:bg-blue-700 transition focus:outline-none focus:ring-2 focus:ring-blue-400'
