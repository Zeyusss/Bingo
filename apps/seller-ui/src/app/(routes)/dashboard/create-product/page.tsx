...
const handleSaveDraft = ()=>{
  ...
  return (
    ...
    {images?.length > 0 && (<ImagePlaceHolder setOpenImageModal={setOpenImageModal} size="765 * 850" pictureUploadingLoader={pictureUploadingLoader} small={false} index={0} images={images} setSelectedImage={setSelectedImage} onImageChange={handleImageChange} onRemove={handleRemoveImage}/>)}
        <div className='grid grid-cols-2 gap-3 mt-4 '>
    {images.slice(1).map((_,index)=>(
      <ImagePlaceHolder setOpenImageModal={setOpenImageModal} size="765 * 850" small={true} key ={index} index={index + 1}  pictureUploadingLoader={pictureUploadingLoader} images={images} setSelectedImage={setSelectedImage} onImageChange={handleImageChange} onRemove={handleRemoveImage}/>
    ))}
    </div>
    </div>
  ...
  {errors.stock && (
    ...
    {openImageModal && (
      ...
      <div className=' relative w-full h-[250px] rounded-sm overflow-hidden border border-gray-600'>
      <Image
      src={selectedImage}
      alt="product-image"
      layout='fill'
