    ...
    <div className='flex flex-col gap-3'>
            ...
            render={({field})=>{
                ...
                {properties.map((property,index)=>(
                    <div key={index}
                    className='border border-gray-700 p-3 rounded-lg bg-[#1E1E1E]'
                    >
                        ...
                        <input
                        type="text"
                        className="border outline-none border-white bg-white p-2 rounded-md text-black w-full"
                ...
                <Input
                placeholder='Enter property label (e.g. )'
                value={newLabel}
